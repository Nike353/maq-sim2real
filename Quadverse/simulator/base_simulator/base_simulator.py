...
class BaseSimulator:
    ...
    def set_task_root_state_tensor(self, set_env_ids, root_states):  
        """
        Sets the root state tensor for specified actors within environments.
        TODO: this is a new method added for manipulation tasks.

        Args:
            set_env_ids (tensor): Tensor of environment IDs where states will be set.
            task_name (str): Name of the task to apply.
            root_states (tensor): New root states to apply.
        """
        raise NotImplementedError("The 'set_task_root_state_tensor' method must be implemented in subclasses.")
